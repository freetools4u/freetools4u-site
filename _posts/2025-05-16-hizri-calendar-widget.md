...
<head>
  ...
  <!-- Structured Data JSON-LD for Review + FAQ -->
...
<body>
  ...
  <script>
    ...
    function updatePreview() {
      ...
      const embedCode = `<iframe src="${iframeURL}" width="${width}" height="${height}" frameborder="0" title="Hijri Gregorian Calendar Widget"></iframe>`;
